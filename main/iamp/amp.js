/*	Script by Lefteris Haritou, Copyright © 1998 -1999
	http://www.geocities.com/~lef
	This Script is free as long as you keep the above credit !
	Copied by Hoang Long for nanomedia, it's free!
*/
var run=-1;
var track=-1;
var cttm=0;
...
function cpy(){
abtdiv.innerHTML=String.fromCharCode(73,110,116,101,114,110,101,116,65,109,112,32,50,46,48,60,98,114,62,98,121,60,98,114,62,76,101,102,116,101,114,105,115,32,72,97,114,105,116,111,117,60,98,114,62,67,111,112,121,105,101,100,32,98,121,32,108,111,110,103);
...
plw.document.write('<HTML><HEAD><TITLE>Playlist</TITLE></HEAD><Body bgcolor="#000000" text="#CCCCCC" style="border:none"><CENTER><Table style="position:absolute;top:0;left:0" width="408" border=0 Cellspacing=1 Cellpadding=2><TR Align="Center" bgcolor="#BFBFBF"><TD><Font size=2 color="#00008D" Face="Arial"><B>#</B></Font></TD><TD><Font size=2 color="#00008D"  Face="Arial"><B>Songtitle</B></Font></TD><TD><Font size=2 color="#00008D"  Face="Arial"><B>Play</B></Font></TD></TR>')
for (x=0; x<songurl.length; x++)
plw.document.write('<TR Align="Center" bgcolor="#005F61"><TD Bgcolor="#9F002F"><Font size=2  Face="Arial"><B>'+(x+1)+'</B></Font></TD><TD><Font size=2  Face="Arial"><B>'+songtitle[x]+'</B></Font></TD><TD Bgcolor="#002870"><IMG SRC="i-abt.gif" WIDTH="18" HEIGHT="18" BORDER="0" onclick="self.close();window.opener.ctrck('+x+')" Alt="Click here to play the song : '+songtitle[x]+'"></TD></TR>')
